...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.cms.settings.store') }}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type" value="{{ old('type') }}" required placeholder="misal: pesantren, site, seo">
                @error('type')
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control @error('nama_pesantren') is-invalid @enderror" id="nama_pesantren" name="nama_pesantren" value="{{ old('nama_pesantren') }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="number" class="form-control @error('tahun_berdiri') is-invalid @enderror" id="tahun_berdiri" name="tahun_berdiri" value="{{ old('tahun_berdiri') }}" min="1900" max="{{ now()->year }}">
                @error('tahun_berdiri')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control @error('pendiri') is-invalid @enderror" id="pendiri" name="pendiri" value="{{ old('pendiri') }}">
                @error('pendiri')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <textarea class="form-control @error('isi_misi') is-invalid @enderror" id="isi_misi" name="isi_misi" rows="3">{{ old('isi_misi') }}</textarea>
                @error('isi_misi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="date" class="form-control @error('tanggal_seleksi_akademik') is-invalid @enderror" id="tanggal_seleksi_akademik" name="tanggal_seleksi_akademik" value="{{ old('tanggal_seleksi_akademik') }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="number" class="form-control @error('biaya_pendaftaran') is-invalid @enderror" id="biaya_pendaftaran" name="biaya_pendaftaran" value="{{ old('biaya_pendaftaran') }}" step="0.01" min="0">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="number" class="form-control @error('biaya_spp') is-invalid @enderror" id="biaya_spp" name="biaya_spp" value="{{ old('biaya_spp') }}" step="0.01" min="0">
                @error('biaya_spp')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
