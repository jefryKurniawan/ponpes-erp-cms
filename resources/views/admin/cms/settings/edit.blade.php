...
@section('title_page', 'Edit Pengaturan CMS')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Pengaturan CMS</h1>
    ...
    <form action="{{ route('admin.cms.settings.update', $setting->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10>
                <input type="date" class="form-control @error('tanggal_buka') is-invalid @enderror" id="tanggal_buka" name="tanggal_buka" value="{{ old('tanggal_buka', $setting->tanggal_buka ? $setting->tanggal_buka->format('Y-m-d') : '') }}">
                @error('tanggal_buka')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10>
                <input type="date" class="form-control @error('tanggal_tutup') is-invalid @enderror" id="tanggal_tutup" name="tanggal_tutup" value="{{ old('tanggal_tutup', $setting->tanggal_tutup ? $setting->tanggal_tutup->format('Y-m-d') : '') }}">
                @error('tanggal_tutup')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10>
                <input type="date" class="form-control @error('tanggal_seleksi_akademik') is-invalid @enderror" id="tanggal_seleksi_akademik" name="tanggal_seleksi_akademik" value="{{ old('tanggal_seleksi_akademik', $setting->tanggal_seleksi_akademik ? $setting->tanggal_seleksi_akademik->format('Y-m-d') : '') }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10>
                <input type="date" class="form-control @error('tanggal_pengumuman') is-invalid @enderror" id="tanggal_pengumuman" name="tanggal_pengumuman" value="{{ old('tanggal_pengumuman', $setting->tanggal_pengumuman ? $setting->tanggal_pengumuman->format('Y-m-d') : '') }}">
