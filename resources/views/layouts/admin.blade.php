        ...
        <nav class="flex-1 px-4 py-2 overflow-y-auto custom-scrollbar">
            ...
            <div class="mb-4">
                ...
                <a class="flex items-center px-4 py-3 rounded-lg transition-all {{ request()->routeIs('home') ? 'cms-sidebar-active' : 'text-on-surface-variant hover:bg-primary-container/10 hover:text-primary' }}" href="{{ route('home') }}">
                    <span class="material-symbols-outlined mr-3 {{ request()->routeIs('home') ? '' : '' }}">dashboard</span>
            ...
            <div class="mb-4">
                ...
                <button class="w-full flex items-center px-4 py-3 rounded-lg transition-all {{ request()->routeIs('registration.*') || request()->routeIs('syahriah.*') ? 'cms-sidebar-active' : 'text-on-surface-variant hover:bg-primary-container/10 hover:text-primary' }}" onclick="this.nextElementSibling.classList.toggle('hidden')">
                    <span class="material-symbols-outlined mr-3 {{ request()->routeIs('registration.*') || request()->routeIs('syahriah.*') ? '' : 'text-primary' }}">file_invoice</span>
                    <span class="font-label-md">Submenu</span>
            ...
            <div class="mb-4">
                ...
                <a class="flex items-center px-4 py-3 rounded-lg transition-all text-on-surface-variant hover:bg-primary-container/10 hover:text-primary" href="#">
                    <span class="material-symbols-outlined mr-3 text-primary">inventory_2</span>
            ...
            <div class="mt-auto pt-8 border-t border-outline-variant/10">
                ...
                <a class="flex items-center px-4 py-3 rounded-lg transition-all {{ request()->routeIs('admin.cms.settings.*') ? 'cms-sidebar-active' : 'text-on-surface-variant hover:bg-primary-container/10 hover:text-primary' }}" href="{{ route('admin.cms.settings.index') }}">
                    <span class="material-symbols-outlined mr-3 {{ request()->routeIs('admin.cms.settings.*') ? '' : 'text-primary' }}">settings</span>
