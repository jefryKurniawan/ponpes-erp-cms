...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h2 class="font-headline-md text-headline-md text-on-surface mb-2">Edit Data Pengguna</h2>
        <p class="font-body-md text-body-md text-on-surface-variant">Perbarui informasi pengguna.</p>
    </div>
        ...
        <div class="cms-card bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input id="email" type="email" class="cms-input w-full @error('email') border-error @enderror" name="email" value="{{ old('email', $user->email) }}" required autocomplete="email">
                    @error('email')
                        <p class="text-error text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label for="password" class="block font-label-sm text-on-surface mb-2">Password Baru</label>
                    <div class="relative">
                    ...
                    @error('password')
                        <p class="text-error text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-on-surface-variant text-xs mt-1">Kosongkan jika tidak ingin mengubah password.</p>
                </div>
            </div>
